...
Businesses across Retail, Finance, Health, Education etc. are transforming, modernizing & updating Architecture & Technology Stacks around Cloud Technologies. The architecture is being developed in a vendor neutral driven by open source communities under [Cloud Native Computing Foundation](https://www.cncf.io/) & other [organizations](https://opensource.com/resources/organizations). The changes are mostl likely going to be accelerated due to COVID.
