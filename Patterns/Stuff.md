...
Let's look at some interesting [System design principles](Design%20Patterns.md), Implementations of **Mobile, Web & Edge** [Applications](https://martinfowler.com/bliki/ApplicationBoundary.html) as **Application Programming Interfaces (APIs)** designed Services and Functions, composability spanning single to multiple request/response using **Workflows** & **Integrations**.
