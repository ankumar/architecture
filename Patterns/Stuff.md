...
We are modernizing technology stacks across all industies with an architecture term **Cloud Native**. A definition from [Cloud Native Computing Foundation](https://www.cncf.io/):
