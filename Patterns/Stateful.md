...
* **Patterns**: [Software](https://en.wikipedia.org/wiki/Software_design_pattern), [Microservices](https://www.oreilly.com/content/why-a-pattern-language-for-microservices/)
