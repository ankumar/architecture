...
* Access patterns - Mapping between application & database structures. The two major categories are the [active record pattern](http://calpaterson.com/activerecord.html) and the [data mapper](https://www.martinfowler.com/eaaCatalog/dataMapper.html) (ORMs & [DTOs](https://martinfowler.com/eaaCatalog/dataTransferObject.html)) pattern. 
