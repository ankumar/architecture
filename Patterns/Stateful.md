...
* **Patterns**: Design patterns are formalized best practices that the programmer can use to solve common problems when designing an application or system, [Software](https://en.wikipedia.org/wiki/Software_design_pattern);[Microservices](https://www.oreilly.com/content/why-a-pattern-language-for-microservices/)
