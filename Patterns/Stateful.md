...
* Access patterns - Mapping  between application & database structures. The two major categories are the [active record pattern and the data mapper pattern](http://calpaterson.com/activerecord.html). 
