...
Organizational boundaries are getting blurred between "Public" & "Private" workspaces & imperative with Cognitive Capacity, Open Source, Deployment of Workloads to Public Cloud & "Edge". I think it started with Security Bug bounty program, now trending in Privacy & Observability.
...
Called Backyard when i used to work at Yahoo!, Now Backstage open source project incubated by Spotify, Adopted as Runway@American Airlines

"Platform" @hundreds of other organizations ...
