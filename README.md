...
**Imagine a world like this repo where we don't think of Servers, Deployment, Distributed, Track & version changes from Code to Configuration, Infrastructure (as Code), workflows just like Code for [Data](https://accelst.com/the-quest-for-the-holy-grail-of-git-for-data/).**
