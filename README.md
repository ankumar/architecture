...
We track & version changes from Code to Configuration, Now Infrastructure (as Code). The developer tooling & experience around Git model is growing, also interesting work happening in managing data & workflows just like code.
