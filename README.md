...
Organizational boundaries are getting blurred between "Public" & "Private" workspaces & imperative with Cognitive load, Open Source, Deployment of Workloads to Public Cloud & "Edge". I think it started with Security Bug bounty program, now trending in Privacy & Observability.
